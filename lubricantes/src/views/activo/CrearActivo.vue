<template>
    <div class="row mt-3">
        <div class="col-md-6 offset-md-3">
            <div class="card">
                <div class="card-header bg-dark text-white text-center">Crear Activo</div>
                <div class="card-body">
...
<script>
    ...
    export default{
        ...
        data(){
            return{
                nombre:'',tipo:'',descripcion:'',color:'',costo:0, url:'http://localhost:3000/activos/'
            }
        }
        ,methods:{
            guardar(){
                ...
                if(this.nombre.trim() === ''){
                    ...
                    enviarSolicitud('POST',parametros,this.url,'Producto guardado',1);
                }
            }
        }
    }
